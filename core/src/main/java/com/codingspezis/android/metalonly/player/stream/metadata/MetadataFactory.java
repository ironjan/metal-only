...
public class MetadataFactory {
    public static final Metadata DEFAULT_METADATA = createMetadata("", "", "", "");
    private static final String DEFAULT_MODERATOR = "MetalHead OnAir";
    private static final String DEFAULT_GENRE = "Mixed Metal";
     ...
     */
    public static Metadata createFromString(String data) {
    ...
    public static Metadata createMetadata(String moderator, String genre, String interpret, String title) {

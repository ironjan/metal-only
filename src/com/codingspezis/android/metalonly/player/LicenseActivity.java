...
public class LicenseActivity extends SubActivity {
	...
	private class ThreadedLicenseReader extends Thread{
		 ...
		 */
		public void setOnLicenseReadListener(OnLicenseReadListener onLicenseReadListener) {
		...
		private String getLicenseText(String license) throws IOException{
			InputStream in = getClass().getResourceAsStream("/com/codingspezis/android/metalonly/player/licenses/"+license+".txt");		
